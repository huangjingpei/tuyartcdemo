...
public class TuyaRTCClient {
    ...
    private final TuyaRTCClient.PCObserver pcObserver = new TuyaRTCClient.PCObserver();
    private final TuyaRTCClient.SDPObserver sdpObserver = new TuyaRTCClient.SDPObserver();
    private final Timer statsTimer = new Timer();
    private final EglBase rootEglBase;
    private final Context appContext;
    private final TuyaRTCClient.PeerConnectionParameters peerConnectionParameters;
    private final TuyaRTCClient.PeerConnectionEvents events;
    ...
    public static class PeerConnectionParameters {
        ...
        public PeerConnectionParameters(boolean videoCallEnabled, boolean loopback, boolean tracing,
                                        ...
                                        TuyaRTCClient.DataChannelParameters dataChannelParameters) {
     ...
     */
    public TuyaRTCClient(Context appContext,
                         PeerConnectionFactory factory,
                         EglBase eglBase,
                         TuyaRTCEngine.TuyaRTCEngineParameters peerConnectionParameters,
                         TuyaRTCClient.PeerConnectionEvents events) {
        this.rootEglBase = eglBase;
        this.factory = factory;
        this.appContext = appContext;
        this.events = events;
        this.peerConnectionParameters = new TuyaRTCClient.PeerConnectionParameters(
                peerConnectionParameters.isVideoCallEnabled(),
                peerConnectionParameters.isLoopback(),
                peerConnectionParameters.isTracing(),
                peerConnectionParameters.getVideoWidth(),
                peerConnectionParameters.getVideoHeight(),
                peerConnectionParameters.getVideoFps(),
                peerConnectionParameters.getVideoMaxBitrate(),
                peerConnectionParameters.getVideoCodec(),
                peerConnectionParameters.isVideoCodecHwAcceleration(),
                peerConnectionParameters.isVideoFlexfecEnabled(),
                peerConnectionParameters.getAudioStartBitrate(),
                peerConnectionParameters.getAudioCodec(),
                peerConnectionParameters.isNoAudioProcessing(),
                peerConnectionParameters.isAecDump(),
                peerConnectionParameters.isSaveInputAudioToFile(),
                peerConnectionParameters.isUseOpenSLES(),
                peerConnectionParameters.isDisableBuiltInAEC(),
                peerConnectionParameters.isDisableBuiltInAGC(),
                peerConnectionParameters.isDisableBuiltInNS(),
                peerConnectionParameters.isDisableWebRtcAGCAndHPF(),
                peerConnectionParameters.isEnableRtcEventLog(),
                null//Disable DataChannel
        );
        this.dataChannelEnabled = (peerConnectionParameters.isDisableDataChannel() != true);
...
//                "OfferToReceiveVideo", Boolean.toString(isVideoCallEnabled())));
    ...
    private @Nullable VideoTrack getRemoteVideoTrackWithPlanB() {
    ...
    private static String getSdpVideoCodecName(TuyaRTCClient.PeerConnectionParameters parameters) {
    ...
    private boolean getAudioMute() {
        if (peerConnection != null) {
            return getAudioEnable();
        }
        return false;
    }
